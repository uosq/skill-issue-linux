...
class ISteamGameServer
{
	...
	STEAM_PRIVATE_API(virtual bool InitGameServer(uint32 unIP, uint16 usGamePort, uint16 usQueryPort,
	...
	virtual HAuthTicket GetAuthSessionTicket(void *pTicket, int cbMaxTicket, uint32 *pcbTicket,
						 const SteamNetworkingIdentity *pSnid) = 0;
	...
	virtual bool SendUserConnectAndAuthenticate_DEPRECATED(uint32 unIPClient, const void *pvAuthBlob,
							       uint32 cubAuthBlobSize, CSteamID *pSteamIDUser) = 0;
	...
	STEAM_PRIVATE_API(virtual void SetMasterServerHeartbeatInterval_DEPRECATED(int iHeartbeatInterval) = 0;
