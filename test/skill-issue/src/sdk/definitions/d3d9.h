...
DEFINE_GUID(IID_IDirect3DVertexDeclaration9, 0xdd13c59c, 0x36fa, 0x4098, 0xa8, 0xfb, 0xc7, 0xed, 0x39, 0xdc, 0x85,
	    0x46);
...
DECLARE_INTERFACE_(IDirect3D9, IUnknown)
{
	...
	STDMETHOD(CheckDeviceType)(THIS_ UINT iAdapter, D3DDEVTYPE DevType, D3DFORMAT DisplayFormat,
				   D3DFORMAT BackBufferFormat, WINBOOL bWindowed) PURE;
	...
	STDMETHOD(CheckDeviceMultiSampleType)(THIS_ UINT Adapter, D3DDEVTYPE DeviceType, D3DFORMAT SurfaceFormat,
					      WINBOOL Windowed, D3DMULTISAMPLE_TYPE MultiSampleType,
					      DWORD * pQualityLevels) PURE;
	...
	STDMETHOD(CreateDevice)(THIS_ UINT Adapter, D3DDEVTYPE DeviceType, HWND hFocusWindow, DWORD BehaviorFlags,
				...
				struct IDirect3DDevice9 * *ppReturnedDeviceInterface) PURE;
};
#undef INTERFACE
...
DECLARE_INTERFACE_(IDirect3DSwapChain9, IUnknown)
{
	...
	STDMETHOD(GetBackBuffer)(THIS_ UINT iBackBuffer, D3DBACKBUFFER_TYPE Type,
				 struct IDirect3DSurface9 * *ppBackBuffer) PURE;
...
DECLARE_INTERFACE_(IDirect3DCubeTexture9, IDirect3DBaseTexture9)
{
	...
	STDMETHOD(GetCubeMapSurface)(THIS_ D3DCUBEMAP_FACES FaceType, UINT Level, IDirect3DSurface9 * *ppCubeMapSurface)
	    PURE;
	STDMETHOD(LockRect)(THIS_ D3DCUBEMAP_FACES face, UINT level, D3DLOCKED_RECT * locked_rect, const RECT *rect,
			    DWORD flags) PURE;
...
#ifdef __CRT_UUID_DECL
__CRT_UUID_DECL(IDirect3DVertexDeclaration9, 0xdd13c59c, 0x36fa, 0x4098, 0xa8, 0xfb, 0xc7, 0xed, 0x39, 0xdc, 0x85,
		0x46);
#endif
...
DECLARE_INTERFACE_(IDirect3DDevice9, IUnknown)
{
	...
	STDMETHOD(GetBackBuffer)(THIS_ UINT iSwapChain, UINT iBackBuffer, D3DBACKBUFFER_TYPE Type,
	...
	STDMETHOD(CreateCubeTexture)(THIS_ UINT EdgeLength, UINT Levels, DWORD Usage, D3DFORMAT Format, D3DPOOL Pool,
				     IDirect3DCubeTexture9 * *ppCubeTexture, HANDLE * pSharedHandle) PURE;
	...
	STDMETHOD(CreateRenderTarget)(THIS_ UINT Width, UINT Height, D3DFORMAT Format, D3DMULTISAMPLE_TYPE MultiSample,
				      DWORD MultisampleQuality, WINBOOL Lockable, IDirect3DSurface9 * *ppSurface,
				      HANDLE * pSharedHandle) PURE;
	STDMETHOD(CreateDepthStencilSurface)(THIS_ UINT Width, UINT Height, D3DFORMAT Format,
					     D3DMULTISAMPLE_TYPE MultiSample, DWORD MultisampleQuality, WINBOOL Discard,
	...
	STDMETHOD(UpdateTexture)(THIS_ IDirect3DBaseTexture9 * pSourceTexture,
	...
	STDMETHOD(Clear)(THIS_ DWORD rect_count, const D3DRECT *rects, DWORD flags, D3DCOLOR color, float z,
			 DWORD stencil) PURE;
	...
	STDMETHOD(DrawIndexedPrimitive)(THIS_ D3DPRIMITIVETYPE, INT BaseVertexIndex, UINT MinVertexIndex,
					UINT NumVertices, UINT startIndex, UINT primCount) PURE;
	STDMETHOD(DrawPrimitiveUP)(THIS_ D3DPRIMITIVETYPE primitive_type, UINT primitive_count, const void *data,
				   UINT stride) PURE;
	...
	STDMETHOD(SetStreamSource)(THIS_ UINT StreamNumber, IDirect3DVertexBuffer9 * pStreamData, UINT OffsetInBytes,
				   UINT Stride) PURE;
	STDMETHOD(GetStreamSource)(THIS_ UINT StreamNumber, IDirect3DVertexBuffer9 * *ppStreamData,
				   UINT * OffsetInBytes, UINT * pStride) PURE;
	...
	STDMETHOD(DrawRectPatch)(THIS_ UINT handle, const float *segment_count, const D3DRECTPATCH_INFO *patch_info)
	    PURE;
...
DECLARE_INTERFACE_(IDirect3D9Ex, IDirect3D9)
{
	...
	STDMETHOD(EnumAdapterModes)(THIS_ UINT adapter_idx, D3DFORMAT format, UINT mode_idx, D3DDISPLAYMODE * mode)
	    PURE;
	STDMETHOD(GetAdapterDisplayMode)(THIS_ UINT adapter_idx, D3DDISPLAYMODE * mode) PURE;
	STDMETHOD(CheckDeviceType)(THIS_ UINT adapter_idx, D3DDEVTYPE device_type, D3DFORMAT display_format,
				   D3DFORMAT backbuffer_format, WINBOOL windowed) PURE;
	...
	STDMETHOD(CheckDeviceMultiSampleType)(THIS_ UINT adapter_idx, D3DDEVTYPE device_type, D3DFORMAT surface_format,
					      WINBOOL windowed, D3DMULTISAMPLE_TYPE multisample_type,
					      DWORD * quality_levels) PURE;
	STDMETHOD(CheckDepthStencilMatch)(THIS_ UINT adapter_idx, D3DDEVTYPE device_type, D3DFORMAT adapter_format,
					  D3DFORMAT rt_format, D3DFORMAT ds_format) PURE;
	STDMETHOD(CheckDeviceFormatConversion)(THIS_ UINT adapter_idx, D3DDEVTYPE device_type, D3DFORMAT src_format,
					       D3DFORMAT dst_format) PURE;
	...
	STDMETHOD(EnumAdapterModesEx)(THIS_ UINT adapter_idx, const D3DDISPLAYMODEFILTER *filter, UINT mode_idx,
				      D3DDISPLAYMODEEX *mode) PURE;
	STDMETHOD(GetAdapterDisplayModeEx)(THIS_ UINT adapter_idx, D3DDISPLAYMODEEX * mode,
					   D3DDISPLAYROTATION * rotation) PURE;
	STDMETHOD(CreateDeviceEx)(THIS_ UINT adapter_idx, D3DDEVTYPE device_type, HWND focus_window, DWORD flags,
				  ...
				  struct IDirect3DDevice9Ex * *device) PURE;
...
#define IDirect3D9Ex_CheckDeviceMultiSampleType(p, a, b, c, d, e, f)                                                   \
	(p)->lpVtbl->CheckDeviceMultiSampleType(p, a, b, c, d, e, f)
...
DECLARE_INTERFACE_(IDirect3DDevice9Ex, IDirect3DDevice9)
{
	...
	STDMETHOD(CreateAdditionalSwapChain)(THIS_ D3DPRESENT_PARAMETERS * parameters, IDirect3DSwapChain9 * *swapchain)
	    PURE;
	...
	STDMETHOD(Present)(THIS_ const RECT *src_rect, const RECT *dst_rect, HWND dst_window_override,
			   const RGNDATA *dirty_region) PURE;
	STDMETHOD(GetBackBuffer)(THIS_ UINT swapchain_idx, UINT backbuffer_idx, D3DBACKBUFFER_TYPE backbuffer_type,
				 IDirect3DSurface9 * *backbuffer) PURE;
	...
	STDMETHOD(CreateTexture)(THIS_ UINT width, UINT height, UINT levels, DWORD usage, D3DFORMAT format,
				 D3DPOOL pool, IDirect3DTexture9 * *texture, HANDLE * shared_handle) PURE;
	STDMETHOD(CreateVolumeTexture)(THIS_ UINT width, UINT height, UINT depth, UINT levels, DWORD usage,
				       D3DFORMAT format, D3DPOOL pool, IDirect3DVolumeTexture9 * *texture,
				       HANDLE * shared_handle) PURE;
	STDMETHOD(CreateCubeTexture)(THIS_ UINT edge_length, UINT levels, DWORD usage, D3DFORMAT format, D3DPOOL pool,
				     IDirect3DCubeTexture9 * *texture, HANDLE * shared_handle) PURE;
	...
	STDMETHOD(CreateDepthStencilSurface)(
	    THIS_ UINT width, UINT height, D3DFORMAT format, D3DMULTISAMPLE_TYPE multisample_type,
	    DWORD multisample_quality, WINBOOL discard, IDirect3DSurface9 * *surface, HANDLE * shared_handle) PURE;
	STDMETHOD(UpdateSurface)(THIS_ IDirect3DSurface9 * src_surface, const RECT *src_rect,
				 IDirect3DSurface9 *dst_surface, const POINT *dst_point) PURE;
	...
	STDMETHOD(BeginScene)(THIS) PURE;
	STDMETHOD(EndScene)(THIS) PURE;
	STDMETHOD(Clear)(THIS_ DWORD rect_count, const D3DRECT *rects, DWORD flags, D3DCOLOR colour, float z,
			 DWORD stencil) PURE;
	STDMETHOD(SetTransform)(THIS_ D3DTRANSFORMSTATETYPE state, const D3DMATRIX *matrix) PURE;
	...
	STDMETHOD(ProcessVertices)(THIS_ UINT src_start_idx, UINT dst_idx, UINT vertex_count,
				   IDirect3DVertexBuffer9 * dst_buffer, IDirect3DVertexDeclaration9 * declaration,
				   DWORD flags) PURE;
	STDMETHOD(CreateVertexDeclaration)(THIS_ const D3DVERTEXELEMENT9 *elements,
					   IDirect3DVertexDeclaration9 **declaration) PURE;
	...
	STDMETHOD(SetStreamSource)(THIS_ UINT stream_idx, IDirect3DVertexBuffer9 * buffer, UINT offset, UINT stride)
	    PURE;
	STDMETHOD(GetStreamSource)(THIS_ UINT stream_idx, IDirect3DVertexBuffer9 * *buffer, UINT * offset,
				   UINT * stride) PURE;
	...
	STDMETHOD(PresentEx)(THIS_ const RECT *src_rect, const RECT *dst_rect, HWND dst_window_override,
			     const RGNDATA *dirty_region, DWORD flags) PURE;
	...
	STDMETHOD(CreateRenderTargetEx)(THIS_ UINT width, UINT height, D3DFORMAT format,
					...
					WINBOOL lockable, IDirect3DSurface9 * *surface, HANDLE * shared_handle,
					DWORD usage) PURE;
	...
	STDMETHOD(CreateDepthStencilSurfaceEx)(THIS_ UINT width, UINT height, D3DFORMAT format,
					       D3DMULTISAMPLE_TYPE multisample_type, DWORD multisample_quality,
					       WINBOOL discard, IDirect3DSurface9 * *surface, HANDLE * shared_handle,
					       DWORD usage) PURE;
	STDMETHOD(ResetEx)(THIS_ D3DPRESENT_PARAMETERS * parameters, D3DDISPLAYMODEEX * mode) PURE;
	STDMETHOD(GetDisplayModeEx)(THIS_ UINT swapchain_idx, D3DDISPLAYMODEEX * mode, D3DDISPLAYROTATION * rotation)
	    PURE;
};
#undef INTERFACE
...
#define IDirect3DDevice9Ex_CreateTexture(p, a, b, c, d, e, f, g, h)                                                    \
	(p)->lpVtbl->CreateTexture(p, a, b, c, d, e, f, g, h)
#define IDirect3DDevice9Ex_CreateVolumeTexture(p, a, b, c, d, e, f, g, h, i)                                           \
	(p)->lpVtbl->CreateVolumeTexture(p, a, b, c, d, e, f, g, h, i)
#define IDirect3DDevice9Ex_CreateCubeTexture(p, a, b, c, d, e, f, g)                                                   \
	(p)->lpVtbl->CreateCubeTexture(p, a, b, c, d, e, f, g)
...
#define IDirect3DDevice9Ex_CreateRenderTarget(p, a, b, c, d, e, f, g, h)                                               \
	(p)->lpVtbl->CreateRenderTarget(p, a, b, c, d, e, f, g, h)
...
#define IDirect3DDevice9Ex_CreateOffscreenPlainSurface(p, a, b, c, d, e, f)                                            \
	(p)->lpVtbl->CreateOffscreenPlainSurface(p, a, b, c, d, e, f)
...
#define IDirect3DDevice9Ex_DrawIndexedPrimitive(p, a, b, c, d, e, f)                                                   \
	(p)->lpVtbl->DrawIndexedPrimitive(p, a, b, c, d, e, f)
#define IDirect3DDevice9Ex_DrawPrimitiveUP(p, a, b, c, d) (p)->lpVtbl->DrawPrimitiveUP(p, a, b, c, d)
#define IDirect3DDevice9Ex_DrawIndexedPrimitiveUP(p, a, b, c, d, e, f, g, h)                                           \
	(p)->lpVtbl->DrawIndexedPrimitiveUP(p, a, b, c, d, e, f, g, h)
...
#define IDirect3DDevice9Ex_CreateRenderTargetEx(p, a, b, c, d, e, f, g, h, i)                                          \
...
#define IDirect3DDevice9Ex_CreateRenderTargetEx(p, a, b, c, d, e, f, g, h, i)                                          \
	(p)->CreateRenderTargetEx(a, b, c, d, e, f, g, h, i)
#define IDirect3DDevice9Ex_CreateOffscreenPlainSurfaceEx(p, a, b, c, d, e, f, g)                                       \
	(p)->CreateOffscreenPlainSurfaceEx(a, b, c, d, e, f, g)
#define IDirect3DDevice9Ex_CreateDepthStencilSurfaceEx(p, a, b, c, d, e, f, g, h, i)                                   \
	(p)->CreateDepthStencilSurfaceEx(a, b, c, d, e, f, g, h, i)
