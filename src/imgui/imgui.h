...
namespace ImGui
{
	...
	IMGUI_API void OpenPopup(const char *str_id, ImGuiPopupFlags popup_flags =
...
enum ImGuiTabBarFlags_
{
	...
	ImGuiTabBarFlags_FittingPolicyMixed =
	    1
	    << 7, // Shrink down tabs when they don't fit, until width is style.TabMinWidthShrink, then enable scrolling buttons.
...
enum ImGuiColorEditFlags_
{
	...
	ImGuiColorEditFlags_AlphaPreviewHalf =
	    1
	    << 13, //              // ColorEdit, ColorPicker, ColorButton: display half opaque / half transparent preview.
...
struct ImGuiStyle
{
	...
	float
	    TabCloseButtonMinWidthSelected; // -1: always visible. 0.0f: visible when hovered. >0.0f: visible when hovered if minimum width.
	float
...
enum ImGuiMultiSelectFlags_
{
	...
	ImGuiMultiSelectFlags_ClearOnClickVoid = 1
...
struct ImDrawList
{
	...
	IMGUI_API void PathEllipticalArcTo(const ImVec2 &center, const ImVec2 &radius, float rot, float a_min,
...
struct ImFontConfig
{
	...
	bool
	    FontDataOwnedByAtlas; // true     // TTF/OTF data ownership taken by the owner ImFontAtlas (will delete memory itself).
...
struct ImFontAtlas
{
	...
	IMGUI_API void
	ClearFonts(); // [OBSOLETE] Clear input+output font data (same as ClearInputData() + glyphs storage, UV coordinates).
	IMGUI_API void
