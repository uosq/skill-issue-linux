...
static bool ImGui_ImplSDL2_Init(SDL_Window *window, SDL_Renderer *renderer, void *sdl_gl_context)
{
	...
	snprintf(bd->BackendPlatformName, sizeof(bd->BackendPlatformName), "imgui_impl_sdl2 (%u.%u.%u, %u.%u.%u)",
		 ver_compiled.major, ver_compiled.minor, ver_compiled.patch, ver_runtime.major, ver_runtime.minor,
		 ver_runtime.patch);
...
static void ImGui_ImplSDL2_UpdateMouseCursor()
{
	...
	else
	{
		...
		SDL_Cursor *expected_cursor = bd->MouseCursors[imgui_cursor] ? bd->MouseCursors[imgui_cursor]
...
static void ImGui_ImplSDL2_GetWindowSizeAndFramebufferScale(SDL_Window *window, SDL_Renderer *renderer,
							    ImVec2 *out_size, ImVec2 *out_framebuffer_scale)
{
	int w, h;
