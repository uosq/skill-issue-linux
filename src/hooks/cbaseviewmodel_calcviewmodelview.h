...
DETOUR_DECL_TYPE (void, original_CalcViewModelView, void *thisptr,
		  CBaseEntity *, const Vector &, const QAngle &);

ADD_SIG (CBaseViewModel_CalcViewModelView, "client.so",
	 "55 48 89 E5 41 57 41 56 41 55 49 89 F5 41 54 49 89 FC 53 48 83 EC "
	 "48 8B 41 08")

inline void HookedCalcViewModelView (void *thisptr, CBaseEntity *owner,
				     ...
				     const QAngle &eyeAngles)
{
	...
	if (owner)
	{
		Hooks_CallHooks ("CalcViewModelView",
	...
	DETOUR_ORIG_CALL (&calcViewModel_ctx, original_CalcViewModelView,
			  thisptr, owner, position, angle);
}

inline void HookCalcViewModelView ()
{
	detour_init (&calcViewModel_ctx,
		     Sigs::CBaseViewModel_CalcViewModelView.GetPointer (),
