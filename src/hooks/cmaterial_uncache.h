...
ADD_SIG (
    CMaterial_Uncache, "materialsystem.so",
    "55 48 89 E5 41 56 41 55 41 54 49 89 FC 53 89 F3 48 81 EC 10 01 00 00")
...
inline void HookedUncache (IMaterial *mat, bool bPreserveVars)
{
	...
	if (mat == nullptr)
	{
		DETOUR_ORIG_CALL (&uncache_ctx, original_Uncache, mat,
				  bPreserveVars);
		return;
	}
...
{
	detour_init (&uncache_ctx, Sigs::CMaterial_Uncache.GetPointer (),
		     (void *)&HookedUncache);
