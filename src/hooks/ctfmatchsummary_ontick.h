...
*/
ADD_SIG(GTFGCClientSystem, "client.so", "E8 ? ? ? ? 4C 8D 6D DC 48 89 C7 E8 ? ? ? ? 4C 89 EF 89 45 DC E8 ? ? ? ? 48 8D 75 D8 4C 89 EA")
...
{
	detour_init(&summary_ontick_ctx, Sigs::CTFMatchSummary_OnTick.GetPointer(), (void*)&Hooked_CTFMatchSummary_OnTick);
