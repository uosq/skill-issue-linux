...
*/
ADD_SIG (CTFMatchSummary_OnTick, "client.so",
	 "55 48 89 E5 41 57 41 56 49 89 FE 41 55 4C 8D 6F 40 41 54 4C 89 EF")
...
static void Hooked_CTFMatchSummary_OnTick (void *self)
{
	...
	*/
	...
	auto gc = reinterpret_cast<uintptr_t (*) ()> (
	    Sigs::GTFGCClientSystem.GetPointer ()) ();
...
{
	detour_init (&summary_ontick_ctx,
		     Sigs::CTFMatchSummary_OnTick.GetPointer (),
