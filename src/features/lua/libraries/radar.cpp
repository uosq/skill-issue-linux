...
namespace LuaFuncs
{
	namespace radar
	{
		...
		{
			LuaVector* localPos = static_cast<LuaVector*>(luaL_checkudata(L, 1, "Vector3"));
			if (localPos == nullptr)
			{
			...
			LuaVector* enemyPos = static_cast<LuaVector*>(luaL_checkudata(L, 2, "Vector3"));
			if (enemyPos == nullptr)
			{
