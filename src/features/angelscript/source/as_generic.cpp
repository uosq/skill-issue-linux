...
int asCGeneric::SetReturnByte(asBYTE val)
{
	...
	if ((sysFunction->returnType.IsObject() || sysFunction->returnType.IsFuncdef()) ||
...
asCGenericVariadic::asCGenericVariadic(asCScriptEngine *engine, asCScriptFunction *sysFunction, void *currentObject,
				       asDWORD *stackPointer, asDWORD stackArgCount)
