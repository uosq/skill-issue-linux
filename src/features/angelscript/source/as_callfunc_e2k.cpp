...
extern "C" void CallFunctionE2K(asFUNCTION_t func, const asQWORD *args, int argsCount, void *retPointer, int retSize,
				int stackSize, bool returnInMemory);

void CallSystemFunctionNative(asCContext *context, asCScriptFunction *descr, void *obj, asDWORD *args, void *retPointer,
			      asQWORD *retQW, void *secondObject)
{
