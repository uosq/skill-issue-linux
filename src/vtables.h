...
namespace vtable
{
	...
	template <size_t I, typename T, typename... Args> inline T call(void *p, Args... args)
	{
		auto vTable = *static_cast<void ***>(p);
		return reinterpret_cast<T (*)(void *, Args...)>(vTable[I])(p, args...);
	}

	template <size_t I, typename T, typename... Args> inline T call(uintptr_t u, Args... args)
	{
