...
class CBaseCombatCharacter : public CBaseFlex
{
	...
	NETVAR (m_hActiveWeapon, "CBaseCombatCharacter->m_hActiveWeapon",
		EHANDLE)
	inline std::array<EHANDLE, MAX_WEAPONS> &m_hMyWeapons ()
	{
		static int nOffset = Netvars::m_netvarMap[fnv::Hash (
		    "CBaseCombatCharacter->m_hMyWeapons")];
		return *reinterpret_cast<std::array<EHANDLE, MAX_WEAPONS> *> (
		    uintptr_t (this) + nOffset);
	}
};