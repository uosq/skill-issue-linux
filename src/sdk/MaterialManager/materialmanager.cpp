...
IMaterial *MaterialManager::CreateMaterial (const std::string &name,
...
ITexture *
MaterialManager::CreateTextureNamedRenderTarget (const std::string &name,
						 int width, int height)
{
	...
	ITexture *tex
	    = interfaces::MaterialSystem->CreateNamedRenderTargetTextureEx (
		name.c_str (), width, height, RT_SIZE_LITERAL,
