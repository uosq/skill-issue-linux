...
bool InitializeInterfaces()
{
	...
	{ // vstdlib factory (console commands)
		...
		KeyValuesSystemFn GetKeyValuesSystem =
		    reinterpret_cast<KeyValuesSystemFn>(dlsym(vstdlib, "KeyValuesSystem"));
	...
	{ // material system factory
		...
		factories::materialsystem =
		    reinterpret_cast<CreateInterfaceFn>(dlsym(materialsystem, "CreateInterface"));
	}
	...
	{ // attribute hook manager
		// get the function
		AttributeHookValue = reinterpret_cast<AttributeHookValueFn>(
		    sigscan_module("client.so", "55 31 C0 48 89 E5 41 57 41 56 41 55 49 "
