...
namespace helper
{
	...
	{
		inline bool CanShoot(CTFPlayer *pLocal, CTFWeaponBase *pWeapon, CUserCmd *pCmd,
		...
		inline void ChatPrintf(int iPlayerIndex, int iFilter, const char *fmt)
		{
			...
			static ChatPrintfFn original = reinterpret_cast<ChatPrintfFn>(
			    sigscan_module("client.so", "55 48 89 E5 41 57 41 56 41 55 49 89 FD 41 54 "
