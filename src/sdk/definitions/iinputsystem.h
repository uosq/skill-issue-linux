...
// yes i pasted the entire steam folder
// no im not gonna write all that goofy ahh shit from scratch
...
class IInputSystem : public IAppSystem
{
	...
	virtual EControllerActionOrigin GetSteamControllerActionOrigin(const char *action,
								       GameActionSet_t action_set)	 = 0;
	virtual EControllerActionOrigin GetSteamControllerActionOrigin(
	    const char *action, ControllerActionSetHandle_t action_set_handle)				      = 0;
