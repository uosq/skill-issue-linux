...
public:
	...
	virtual const model_t* FindOrLoadModel(const char* name) { return nullptr; }
	virtual void InitDynamicModels() { return; }
	virtual void ShutdownDynamicModels() { return; }
	virtual void AddDynamicModel(const char* name, int nModelIndex = -1) { return; }
	virtual void ReferenceModel(int modelindex) { return; }
	virtual void UnreferenceModel(int modelindex) { return; }
	virtual void CleanupDynamicModels(bool bForce = false) { return; }
