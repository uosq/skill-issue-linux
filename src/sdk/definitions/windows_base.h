...
template <typename T> constexpr GUID __uuidof_helper();
...
#define DECLARE_UUIDOF_HELPER(type, a, b, c, d, e, f, g, h, i, j, k)                                                   \
	extern "C++"                                                                                                   \
	{                                                                                                              \
		template <> constexpr GUID __uuidof_helper<type>()                                                     \
		{                                                                                                      \
	...
	{                                                                                                              \
		template <> constexpr GUID __uuidof_helper<type *>()                                                   \
		{                                                                                                      \
			return __uuidof_helper<type>();                                                                \
		}                                                                                                      \
	}                                                                                                              \
	extern "C++"                                                                                                   \
	{                                                                                                              \
		template <> constexpr GUID __uuidof_helper<const type *>()                                             \
		{                                                                                                      \
			return __uuidof_helper<type>();                                                                \
		}                                                                                                      \
	}                                                                                                              \
...
#else
#define DEFINE_GUID(iid, a, b, c, d, e, f, g, h, i, j, k) static const GUID iid = {a, b, c, {d, e, f, g, h, i, j, k}};
#define DECLARE_UUIDOF_HELPER(type, a, b, c, d, e, f, g, h, i, j, k)
#endif // __cplusplus

#define __CRT_UUID_DECL(type, a, b, c, d, e, f, g, h, i, j, k)                                                         \
	DECLARE_UUIDOF_HELPER(type, a, b, c, d, e, f, g, h, i, j, k)
