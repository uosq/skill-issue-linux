...
enum RenderGroup_t
{
	...
	RENDER_GROUP_OPAQUE_STATIC =
	    RENDER_GROUP_OPAQUE_STATIC_HUGE + (RENDER_GROUP_CFG_NUM_OPAQUE_ENT_BUCKETS - 1) * 2,
...
class IClientLeafSystemEngine
{
	...
	virtual void AddRenderableToLeaves(ClientRenderHandle_t renderable, int nLeafCount,
