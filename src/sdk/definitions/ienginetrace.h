...
class IEngineTrace
{
	...
	virtual void SetupLeafAndEntityListBox(const Vector &vecBoxMin, const Vector &vecBoxMax,
	...
	virtual void EnumerateEntities(const Vector &vecAbsMins, const Vector &vecAbsMaxs,
	...
	virtual void GetBrushesInAABB(const Vector &vMins, const Vector &vMaxs, void *pOutput,
	...
	virtual bool PointOutsideWorld(
	    const Vector &ptTest) = 0; //Tests a point to see if it's outside any playable area
