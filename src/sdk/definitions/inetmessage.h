...
class NET_SetConVar : public CNetMessage
{
	...
	{
		CVar_t localCvar;
		strncpy(localCvar.Name, name, MAX_OSPATH);
		strncpy(localCvar.Value, value, MAX_OSPATH);
...
class CLC_RespondCvarValue : public CNetMessage
{
	...
	const char *
	    m_szCvarValue; // The sender sets this, and it automatically points it at m_szCvarNameBuffer when receiving.
