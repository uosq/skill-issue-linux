...
enum ESNetSocketState
{
	...
	k_ESNetSocketStateReceivedRemoteCandidates =
	    12, // we've received information from the remote machine, via the Steam back-end, about their IP info
	...
	k_ESNetSocketStateConnectionBroken =
	    25, // connection has been broken; either the other end has disappeared or our local network connection has broke
};
...
class ISteamNetworking
{
	...
	virtual bool RetrieveDataFromSocket(SNetSocket_t hSocket, void *pubDest, uint32 cubDest,
...
STEAM_DEFINE_GAMESERVER_INTERFACE_ACCESSOR(ISteamNetworking *, SteamGameServerNetworking,
...
struct SocketStatusCallback_t
{
	...
	SNetListenSocket_t
	    m_hListenSocket; // this is the server socket that we were listening on; NULL if this was an outgoing connection
