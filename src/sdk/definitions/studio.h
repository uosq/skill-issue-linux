...
struct mstudiolinearbone_t
{
	...
	int posetoboneindex;
	inline matrix3x4 *poseToBone(int i) const
	{
		return ((matrix3x4 *)(((byte *)this) + posetoboneindex) + i);
	};
	int posscaleindex;
...
struct mstudioseqdesc_t
{
	...
	inline mstudioactivitymodifier_t *pActivityModifier(int i) const
	{
		return activitymodifierindex != 0
			   ? (mstudioactivitymodifier_t *)(((byte *)this) + activitymodifierindex) + i
			   : NULL;
	};
	int unused[5];
};
...
struct mstudioflexcontrollerui_t
{
	...
	{
		return remaptype == FLEXCONTROLLER_REMAP_NWAY ? (mstudioflexcontroller_t *)((char *)this + szindex2)
							      : NULL;
	}
...
struct mstudioflex_t
{
	...
	{
		return (vertanimtype == STUDIO_VERT_ANIM_NORMAL) ? sizeof(mstudiovertanim_t)
...
struct studiohdr_t
{
	...
	{
		return (flags & STUDIOHDR_FLAGS_VERT_ANIM_FIXED_POINT_SCALE) ? flVertAnimFixedPointScale
									     : 1.0f / 4096.0f;
	}
	int unused3[1];
	int studiohdr2index;
